...
public class MainActivity extends AppCompatActivity {
    ...
    public void showNotification() {
        ...
        Notification notification = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("Baby just woked up")
                .setContentText("check up fast!!")
                .setContentIntent(pi)
                .setAutoCancel(true)
                .build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                nannyConnector.sendNotifyRequest();
            }
        });

        musicToggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                nannyConnector.sendMusicRequest();
            }
        });

        motorToggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                nannyConnector.sendMotorRequest();
            }
        });
